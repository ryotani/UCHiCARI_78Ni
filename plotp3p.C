...
int life4=165; int Eve[nn]={/*242, */307, 557}, ymax=28; char *output=Form("fig/p3p_78Ni_10d_Sep2019_%ips_%ikeV",life4,bin);
//int life4=0; int Eve[nn]={1000,1000,1000}, bin=20, ymax=28; char *output=Form("fig/p3p_78Ni_1000eve_Aug2019_%ips",life4);
int sumeve=0;
int expeve=(int)(1.02*104./446./(1.36e-3)*9./6.); //6day ->10day with 90% livetime
